...
LeftListItem::LeftListItem(entry_ref *ref, char *name, BBitmap *icon, struct AudioInfo *Info) : BListItem() {
		fref = *ref;
		strcpy(fname,name);
		ficon = icon;
...
LeftList::LeftList (BRect size) : BListView(size,"LeftList",B_MULTIPLE_SELECTION_LIST,B_FOLLOW_NONE,B_WILL_DRAW) {
