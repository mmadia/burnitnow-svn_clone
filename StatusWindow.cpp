...
int32 TRACK_FIN;
StatusView::StatusView(BRect r, char *title) : BView(r,title,B_FOLLOW_NONE,B_WILL_DRAW)
{
...
StatusWindow::StatusWindow(char *title) : BWindow(BRect(220,200,500,270),"StatusWindow",B_FLOATING_WINDOW_LOOK,B_MODAL_APP_WINDOW_FEEL,B_NOT_ZOOMABLE | B_NOT_RESIZABLE | B_NOT_CLOSABLE)
{
	BRect r;
	if(title != NULL)
		SetTitle(title);
